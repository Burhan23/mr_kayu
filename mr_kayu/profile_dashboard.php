...
<body style="background-image: url('css/darkbrown3.png'); background-size:cover;background-color:darkslategrey;">
    <?php
        foreach ($userini as $akun) {
          if ($akun['role'] == '1') {
    ?>
    <nav class="nav">
      <a class="nav-link" href = "dashboard.php">Back to HomePage</a></nav>
    <?php } 
          elseif ($akun['role'] == '2') {
    ?>
    <nav class="nav">
        ...
        <div class="text-center">
          ...
          <div>
            ...
            <a href="#" class="btn btn-primary">
            	Ubah Data Akun <i class="bi bi-lock-fill"></i>
            </a>
            </div>
          </div>
		</div>
