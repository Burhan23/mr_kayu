...
<html lang="en">
  ...
  <body>
    <nav class="nav">
      <a href="index_pengrajin.php" class="nav-link"><i class="bi bi-boxes"></i> Produk</a>
      <a href="add.php" class="nav-link"><i class="bi bi-box-arrow-up"></i> Upload</a>
      <a href="approval_invest.php" class="nav-link"><i class="bi bi-list-task"></i> Cek Investasi</a>
      <a href="deskripsi.php" class="nav-link"><i class="bi bi-journal-text"></i> Deskripsi</a>
      <a href="progres.php" class="nav-link"><i class="bi bi-box-seam"></i> Progres</a>
      <a href="progres_selesai.php" class="nav-link"><i class="bi bi-box-seam-fill"></i> Produk Selesai</a>
