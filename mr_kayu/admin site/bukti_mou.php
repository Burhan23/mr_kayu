...
<html lang="en" dir="ltr">
  ...
  <article>
  <a class="btn btn-primary btn-lg" style="padding-left: 10px; padding-right:10px;" onclick="JavaScript:window.location.href='download.php?file=<?php echo $_REQUEST['mou'] ?>';">Download MOU Disini</a>
  <br>
  <a href="list_mou.php" class="btn btn-secondary btn-sm" style="width:15%;"  name="submit"><--Kembali</a>
  </article>
    </section>
    <br> <br>
  </body>
